        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I’m a developer who loves turning ideas into interactive web experiences. I enjoy working on full-stack applications, designing smooth user interfaces, and experimenting with modern tools like React, Tailwind, and animation libraries. I’m always learning, building, and pushing myself to create better digital experiences.
            </p>
